const questions = [
    {
         question: "Who won the Indian Grand Prix?",
         answers:[
    ...
    {
        question: "For which team Lewis Hamilton playing for?",
         answers:[
            {text: "Ferrari", correct: true},
            {text: "Macleren", correct: false},
    ...
    {
        question: "What is full form of DRS?",
         answers:[
            {text: "Decision Review System", correct: false},
            {text: "Drag Reduction System", correct: true},
            {text: "Dynamic Racing System", correct: false},
            {text: "Drag Racing System", correct: false},
         ]
    }
];
